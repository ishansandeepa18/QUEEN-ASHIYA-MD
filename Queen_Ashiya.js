...
module.exports = Ashiya = async (Ashiya, m, chatUpdate, store) => {
    try {
        ...
        const botNumber = await Ashiya.decodeJid(Ashiya.user.id)
        ...
        //group\\
        const groupMetadata = m.isGroup ? await Ashiya.groupMetadata(m.chat).catch(e => {}) : ''
	...
	//group target \\
const reply = (teks) => {
            Ashiya.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` 💞 𝚀𝚄𝙴𝙴𝙽 𝙰𝚂𝙷𝙸𝚈𝙰 💞`,"body": ` ᴘᴏᴡᴇʀᴇᴅ ʙʏ  ɪꜱʜᴀɴ ꜱᴀɴᴅᴇᴇᴘᴀ`, "previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/3M1pzNm/Ashiya.jpg`,"thumbnail": fs.readFileSync(`./Queen_Ashiya_Media/Ashiya.jpg`),"sourceUrl": "https://i.ibb.co/3M1pzNm/Ashiya.jpg"}}}, { quoted: m})
        ...
        if (m.message) {
            Ashiya.sendReadReceipt(m.chat, m.sender, [m.key.id])
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await Ashiya.setStatus(`${Ashiya.user.name} | Runtime : ${runtime(uptime)}`)
      ...
      return
        ...
        let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
            userJid: Ashiya.user.id,
            quoted: m.quoted && m.quoted.fakeObj
        })
        messages.key.fromMe = areJidsSameUser(m.sender, Ashiya.user.id)
        ...
        Ashiya.ev.emit('messages.upsert', msg)
        }
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
            Ashiya.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `🎮 Guess The Music 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `🎮 Guess The Picture 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `🎮 Guess The Word 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess blank', buttonText: { displayText: 'Guess The Blank' }, type: 1 }], `🎮 Guess The Blank 🎮\n\nCorrect Answer 🎉\n*${deskripsi}*\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess The Sentence' }, type: 1 }], `🎮 Guess The Sentence 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `🎮 Guess The Lyrics 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess riddle', buttonText: { displayText: 'Guess The Riddle' }, type: 1 }], `🎮 Guess The Riddle 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Press The Button Below`, Ashiya.user.name, m)
...
Typed *surrender* to surrender and admited defeat`
	    ...
	    if (room.x !== room.o) await Ashiya.sendText(room.x, str, m, { mentions: parseMention(str) } )
	    await Ashiya.sendText(room.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
...
const reactionMessage = {
	    ...
	    Ashiya.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} Refuse Suit, Suit Canceled`, m)
	    ...
	    Ashiya.sendText(m.chat, `Suit Has Been Sent To Chat
...
Click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) Ashiya.sendText(roof.p, `Please Select \n\Rock🗿\nPaper📄\nScissors✂️`, m)
	    if (!roof.pilih2) Ashiya.sendText(roof.p2, `Please Select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) Ashiya.sendText(m.chat, `Both Players Don't Want To Play,\nSuit Canceled`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    Ashiya.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Didn't Choose Suit, Game Over!`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) Ashiya.sendText(roof.p2, '_The Opponent Has Chosen_\nNow It Is Your Turn', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    reply(`You Have Chosen ${m.text} ${!roof.pilih ? `\n\nWaiting For The Opponent To Choose` : ''}`)
	    if (!roof.pilih) Ashiya.sendText(roof.p, '_The Opponent Has Chosen_\nNow It Is Your Turn', 0)
	    }
	    ...
	    Ashiya.sendText(roof.asal, `_*Suit Results*_${tie ? '\nSERIES' : ''}
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     var Ashiya = await getBuffer(picak+`User's Inventory`)
     ...
     await Ashiya.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, Ashiya, [{"urlButton": {"displayText": "YouTube📍","url": `${myweb}`}}])
  }
  break
        case 'userlimit': 
{      
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  let buttons = [
    ...
    let buttonMessage = {
     ...
     Ashiya.sendMessage(from, buttonMessage, { quoted: m })
...
Type *surrender* to surrender and admit defeat`
            ...
            if (this.game) {
            delete this.game
            Ashiya.sendText(m.chat, `Successfully Deleted The TicTacToe Session`, m)
            } else if (!this.game) {
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`
            this.suit[id] = {
            chat: await Ashiya.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) Ashiya.sendText(m.chat, `_Suit Time Out_`, m)
            delete this.suit[id]
            ...
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    Ashiya.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    Ashiya.chatModify({ mute: null }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    Ashiya.chatModify({  archive: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    Ashiya.chatModify({ archive: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    Ashiya.chatModify({ markRead: true }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    Ashiya.chatModify({ markRead: false }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    Ashiya.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
	    case 'family100': {
                ...
                _family100['family100'+m.chat] = {
                    id: 'family100'+m.chat,
                    pesan: await Ashiya.sendText(m.chat, hasil, m),
                    ...random,
            ...
            case 'guess': {
                ...
                if (args[0] === "song") {
                    ...
                    let msg = await Ashiya.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    Ashiya.sendText(m.chat, `What Is The Name Of This Song?\n\nArtist : ${result.artist}\nTime : 60 seconds`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Guess The Song' }, type: 1 }], `Time Has Run Out\nAnswer:  ${tebaklagu[m.sender.split('@')[0]]}\n\nWant To Play? Press The Button Below`, Ashiya.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Ashiya.sendImage(m.chat, result.img, `Please Answer The Questions Above\n\nDescription : ${result.deskripsi}\nTime : 60 seconds`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Guess The Picture' }, type: 1 }], `Time Has Run Out\nAnswer:  ${tebakgambar[m.sender.split('@')[0]]}\n\nWant To Play Again? PressThe Button Below`, Ashiya.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'word') {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Ashiya.sendText(m.chat, `Please Answer The Following Question\n\n${result.soal}\nTime : 60 seconds`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Guess The Word' }, type: 1 }], `Time Out\nAnswer:  ${tebakkata[m.sender.split('@')[0]]}\n\nWant To Play Again? PressThe Button Below`, Ashiya.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Answer: " + result.jawaban)
                    Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Guess The Sentence' }, type: 1 }], `Time Out\nAnswer:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nWant To Play Again? PressThe Button Below`, Ashiya.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Ashiya.sendText(m.chat, `These Are The Lyrics Of Which Song? : *${result.soal}*?\nTime : 60 seconds`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Answer: " + result.jawaban)
                    Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Guess The Lyrics' }, type: 1 }], `Time Out\nAnswer:  ${tebaklirik[m.sender.split('@')[0]]}\n\Want To Play Again? PressThe Button Below`, Ashiya.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Ashiya.sendText(m.chat, `*Answer The Following Questions :*\n${result.soal}*\nTime : 60 seconds`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Answer: " + result.jawaban)
                    Ashiya.sendButtonText(m.chat, [{ buttonId: 'guess blank', buttonText: { displayText: 'Guess The Blank' }, type: 1 }], `Time Out\nAnswer:  ${caklontong[m.sender.split('@')[0]]}\nDescription : ${caklontong_desk[m.sender.split('@')[0]]}\n\Want To Play Again? PressThe Button Below`, Ashiya.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
	...
	case 'react': {
            ...
            case 'kuismath': case '.math': {
                ...
                Ashiya.sendText(m.chat, `*What Is The Result Of: ${result.soal.toLowerCase()}*?\n\nTime: ${(result.waktu / 1000).toFixed(2)} second`, m).then(() => {
...
Cieeee, What's Going On❤️💖👀`
            ...
            let buttons = [
                    ...
                    await Ashiya.sendButtonText(m.chat, buttons, jawab, Ashiya.user.name, m, {mentions: menst})
            }
            break
            case 'is':
...
Ashiya.sendMessage(from, { text: `Question : Is ${q}\nAnswer : ${kah}` }, { quoted: m })
...
Ashiya.sendMessage(from, { text: `Question : What ${q}\nAnswer : ${kahk}` }, { quoted: m })
...
Ashiya.sendMessage(from, { text: `Question : Can ${q}\nAnswer : ${ga}` }, { quoted: m })
...
Ashiya.sendMessage(from, { text: `Question : ${q}\nAnswer : How ${ya}` }, { quoted: m })
...
Ashiya.sendMessage(from, { text: `Rate : ${q}\nAnswer : *${te}%*` }, { quoted: m })
...
Ashiya.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${teng}%*` }, { quoted: m })
...
Ashiya.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
					...
					Ashiya.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
				     break
...
case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
            ...
            case 'join': {
                ...
                await Ashiya.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
            case 'leave': {
                if (!isCreator) return replay(`${mess.owner}`)
                await Ashiya.groupLeave(m.chat).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
            }
            break
            case 'setexif': {
               if (!isCreator) return replay(`${mess.owner}`)
	...
	case 'add': {
		...
		await Ashiya.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'promote': {
		if (!m.isGroup) return replay(`${mess.group}`)
		...
		await Ashiya.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	case 'demote': {
		if (!m.isGroup) return replay(`${mess.group}`)
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Ashiya.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
        case 'block': {
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Ashiya.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
        case 'unblock': {
		if (!isCreator) return replay(`${mess.owner}`)
		let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
		await Ashiya.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
	}
	break
	    case 'setname': case 'setgcname': case 'setsubject': {
          ...
          case 'setdesc': case 'setdesk': {
                ...
                if (!text) replay(`Where Is The Text?`)
                await Ashiya.groupUpdateDescription(m.chat, text).then((res) => reply(mess.success)).catch((err) => reply(jsonformat(err)))
            }
            break
          case 'setbotpp': {
                if (!isCreator) return replay(`${mess.owner}`)
                ...
                let media = await Ashiya.downloadAndSaveMediaMessage(quoted)
                await Ashiya.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
                reply(mess.success)
                }
                break
           case 'setgrouppp': case 'setgruppp': case 'setgcpp': {
                ...
                if (/webp/.test(mime)) return replay(`Send/Reply Image With Caption ${prefix + command}`)
                let media = await Ashiya.downloadAndSaveMediaMessage(quoted)
                await Ashiya.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
                reply(mess.success)
                }
                break
            case 'tagall': {
...
let teks = `╚»˙·٠•●♥ Tag All ♥●•٠·˙«╝ 
 ...
 ➲ *Message : ${q ? q : 'no message'}*\n\n`
                ...
                Ashiya.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
                }
                break
                case 'hidetag': {
            if (!m.isGroup) return replay(`${mess.group}`)
            if (!isBotAdmins) return replay(`${mess.botAdmin}`)
            if (!isAdmins) return replay(`${mess.admin}`)
            Ashiya.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: m })
            }
            break
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: 'Devote'}, type: 1}
            ...
            let buttonMessageVote = {
                text: teks_vote,
                footer: Ashiya.user.name,
                buttons: buttonsVote,
                headerType: 1
            }
            Ashiya.sendMessage(m.chat, buttonMessageVote)
	    }
            break
               case 'upvote': {
            if (!m.isGroup) return replay(`${mess.group}`)
...
*${prefix}delvote* - To Delete Vote Session`
            ...
            Ashiya.sendMessage(m.chat, buttonMessageUpvote)
	    }
             break
                case 'devote': {
            if (!m.isGroup) return replay(`${mess.group}`)
...
*${prefix}delvote* - To Delete Vote Session`
            ...
            Ashiya.sendMessage(m.chat, buttonMessageDevote)
	}
            break
...
©${Ashiya.user.id}
`
Ashiya.sendTextWithMentions(m.chat, teks_vote, m)
break
		...
		if (!isAdmins) return replay(`${mess.admin}`)       
            ...
            case 'editinfo': {
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
             if (args[0] === 'open'){
                await Ashiya.groupSettingUpdate(m.chat, 'unlocked').then((res) => reply(`Successfully Opened Edit Group Info`)).catch((err) => reply(jsonformat(err)))
             } else if (args[0] === 'close'){
                await Ashiya.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Successfully Closed Edit Group Info`)).catch((err) => reply(jsonformat(err)))
             } else {
             let buttons = [
                        { buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
                        { buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
                    ]
                    await Ashiya.sendButtonText(m.chat, buttons, `Mode Edit Info`, Ashiya.user.name, m)
	       ...
	       if (!m.isGroup) return replay(`${mess.group}`)
             ...
             case '.mute': {
                ...
                reply(`${Ashiya.user.name} Has Been Muted In This Group !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return reply(`Previously Inactive`)
                db.data.chats[m.chat].mute = false
                reply(`${Ashiya.user.name} Has Been Unmuted In This Group!`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await Ashiya.sendButtonText(m.chat, buttons, `Mute Bot`, Ashiya.user.name, m)
                }
             }
             break
            case 'linkgroup': case 'linkgc': case 'gclink': case 'grouplink': {
                if (!m.isGroup) return replay(`${mess.group}`)
                let response = await Ashiya.groupInviteCode(m.chat)
                Ashiya.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\n${groupMetadata.subject} Group Link`, m, { detectLink: true })
            }
            break
            case 'ephemeral': {
                ...
                if (args[0] === 'enable') {
                    await Ashiya.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'disable') {
                    await Ashiya.sendMessage(m.chat, { disappearingMessagesInChat: false }).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                }
            }
            break
            case 'delete': case 'del': {
                ...
                Ashiya.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
            }
            break
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) return replay(`${mess.owner}`)
                if (!text) return replay(`Where Is The Text?\n\nExample : ${prefix + command} Nexus Handsome`)
                let getGroups = await Ashiya.groupFetchAllParticipating()
		...
		reply('Broadcast Success')
            ...
            case 'chatinfo': case 'infochat': {
                ...
                Ashiya.sendTextWithMentions(m.chat, teks, m)
            }
            break
            case 'q': case 'quoted': {
		if (!m.quoted) return reply('Reply Message!!')
		let wokwol = await Ashiya.serializeM(await m.getQuotedObj())
            ...
            case 'listpc': case 'pclist': {
             ...
             break
                case 'listgc': case 'gclist': {
                 ...
                 for (let i of anu) {
                     let metadata = await Ashiya.groupMetadata(i)
             ...
             case 'listonlinexxx': case 'onlinelistxxx': {
                    ...
                    Ashiya.sendText(m.chat, 'Online List:\n\n' + online.map(v => '📝 @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
...
break
	    ...
	    break
            case 'toimage': case 'toimg': {
                ...
                exec(`ffmpeg -i ${media} ${ran}`, (err) => {
                    ...
                    Ashiya.sendMessage(m.chat, { image: buffer }, { quoted: m })
                    fs.unlinkSync(ran)
                })
            }
            break
		...
		let { webp2mp4File } = require('./lib/uploader')
                ...
                await Ashiya.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: m })
            ...
            Ashiya.sendMessage(m.chat, {audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
            }
            break
            case 'tomp3': {
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            Ashiya.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${Ashiya.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            Ashiya.sendMessage(m.chat, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
            }
            break
            case 'togif': {
                if (!quoted) return reply(`Reply Image`)
		...
		let { webp2mp4File } = require('./lib/uploader')
                let media = await Ashiya.downloadAndSaveMediaMessage(quoted)
                let webpToMp4 = await webp2mp4File(media)
                await Ashiya.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
                await fs.unlinkSync(media)
            }
            break
	        case 'tourl': {
	    ...
	    localFile = await Ashiya.downloadAndSaveMediaMessage(quoted, hmm)
	    ...
	    Ashiya.sendMessage(m.chat, {image: fs.readFileSync(outputFile), caption: mess.success}, { quoted : m })
	    ...
	    case 'yts': case 'ytsearch': {
                ...
                Ashiya.sendMessage(m.chat, { image: { url: search.all[0].thumbnail },  caption: teks }, { quoted: m })
            }
            break
        case 'google': {
...
😊 ඔයාට ඕන Audio එකේ Quality එක පහතින් තෝරන්න...  `,
		...
		if (!text) return reply(`Example : ${prefix + command} අල්ලන් යන්න බැරි අතක්`)
                ...
                let anu = search.videos[0]
                let buttons = [
                    {buttonId: `ytmp31 ${anu.url}`, buttonText: {displayText: '🎵 𝗔𝗨𝗗𝗜𝗢 🎵 '}, type: 1},
		    {buttonId: `documentfile1 ${anu.url}`, buttonText: {displayText: '📃 𝐀𝐔𝐃𝐈𝐎 𝐃𝐎𝐂𝐔𝐌𝐄𝐍𝐓 📃'}, type: 1},
                ]
                let buttonMessage = {
                    image: { url: anu.thumbnail },
                    caption: `
...
😊 ඔයාට ඕන වීඩීයෝ එකේ Quality එක, පහතින් තෝරන්න 👇  `,
		...
		let urls = quoted.text.match(new RegExp(/(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/, 'gi'))
                ...
                Ashiya.sendImage(m.chat, media.thumb, `📝 Title : ${media.title}\n📝 File Size : ${media.filesizeF}\n📝 Url : ${urls[text - 1]}\n📝 Ext : MP3\n📝 Resolution : ${args[1] || '128kbps'}`, m)
                Ashiya.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: m })
            }
            break
            case 'getvideoxxx': {
		...
		let { pinterest } = require('./lib/scraper')
                ...
                Ashiya.sendMessage(m.chat, { image: { url: result }, caption: '📝 Media Url : '+result }, { quoted: m })
            }
            break
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
             ...
             let anu = await maker.textpro(link, q)
                Ashiya.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname},For my Darling ` }, { quoted: m })
             }
             break
            case 'drakorxxx':
                if (!text) return reply('What Are You Looking For??')
            ...
            case 'animexxx':{
				...
				await Ashiya.send5ButLoc(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
                })
                .catch((err) => {
                    reply(mess.error)
                })
...
Ashiya.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${global.ownername}`)
...
break
            case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                reply(mess.wait)
                Ashiya.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'Generated Random ' + command }, { quoted: m })
            }
            break
	    case 'couplepp':  case 'ppcouple': {
                ...
                let random = anu[Math.floor(Math.random() * anu.length)]
                Ashiya.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male🙎🏻‍♂️` }, { quoted: m })
                Ashiya.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female🙎🏻‍♀️` }, { quoted: m })
            }
	    break
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            case '3dchristmas': case '3ddeepsea': case 'americanflag': case '3dscifi': case '3drainbow': case '3dwaterpipe': case 'halloweenskeleton': case 'sketch': case 'bluecircuit': case 'space': case 'metallic': case 'fiction': case 'greenhorror': case 'transformer': case 'berry': case 'thunder': case 'magma': case '3dcrackedstone': case '3dneonlight': case 'impressiveglitch': case 'naturalleaves': case 'fireworksparkle': case 'matrix': case 'dropwater':  case 'harrypotter': case 'foggywindow': case 'neondevils': case 'christmasholiday': case '3dgradient': case 'blackpink': case 'gluetext': {
                ...
                reply(mess.wait)
                Ashiya.sendMessage(m.chat, { image: { url: api('zenz', '/textpro/' + command, { text: text }, 'apikey') }, caption: `Text Pro ${command}` }, { quoted: m})
	    }
            break
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Name :* ${anu.message.nama}\n📝 *Meaning :* ${anu.message.arti}\n📝 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Wedding Date :* ${anu.message.tanggal}\n📝 *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Born :* ${anu.message.hari_lahir}\n📝 *Business :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendImage(m.chat, anu.message.image, `📝 *Born :* ${anu.message.tgl_lahir}\n📝 *Tarot Symbol :* ${anu.message.simbol_tarot}\n📝 *Meaning :* ${anu.message.arti}\n📝 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            ...
            case 'haribaik': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Born :* ${anu.message.tgl_lahir}\n📝 *When Challenged :* ${anu.message.kala_tinantang}\n📝 *Info :* ${anu.message.info}\n📝 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Date :* ${anu.message.tgl_memancing}\n📝 *Results :* ${anu.message.result}\n📝 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Results :* ${anu.message.result}\n📝 *Notes :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
                ...
                if (anu.status == false) return reply(anu.message)
                Ashiya.sendText(m.chat, `📝 *Results :* ${anu.message}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return reply('Your Daily Limit Has Expired')
            ...
            case 'tiktokmp3x': case 'tiktokaudiox': {
                ...
                let msg = await Ashiya.sendMessage(m.chat, buttonMessage, { quoted: m })
                Ashiya.sendMessage(m.chat, { audio: { url: anu.result.audio }, mimetype: 'audio/mpeg'}, { quoted: msg })
            }
            break
	        case 'instagramx': case 'igx': case 'igdlx': {
                ...
                if (/(?:\/p\/|\/reel\/|\/tv\/)([^\s&]+)/.test(isUrl(text)[0])) {
                    ...
                    for (let media of anu.data) Ashiya.sendMedia(m.chat, media, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
                } else if (/\/stories\/([^\s&]+)/.test(isUrl(text)[0])) {
                    let anu = await fetchJson(api('zenz', '/downloader/instastory', { url: isUrl(text)[0] }, 'apikey'))
                    Ashiya.sendMedia(m.chat, anu.media[0].url, '', `Download Url Instagram From ${isUrl(text)[0]}`, m)
                }
            }
            break
		...
		case 'igeh': case 'instagram2x': case 'ig2': case 'igdl2': {
                ...
                Ashiya.sendMessage(m.chat, { video: { url: anu.data[0] } }, { quoted: m })
            }
            break
            case 'joox': case 'jooxdl': {
                ...
                let msg = await Ashiya.sendImage(m.chat, anu.result.img, `📝 Title : ${anu.result.lagu}\n📝 Album : ${anu.result.album}\n📝 Singer : ${anu.result.penyanyi}\n📝 Publish : ${anu.result.publish}\n📝 Lyrics :\n${anu.result.lirik.result}`, m)
                Ashiya.sendMessage(m.chat, { audio: { url: anu.result.mp4aLink }, mimetype: 'audio/mpeg', fileName: anu.result.lagu+'.m4a' }, { quoted: msg })
            }
            break
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await Ashiya.sendImage(m.chat, anu.result.thumb, `📝 Title : ${anu.result.title}\n📝 Url : ${isUrl(text)[0]}`)
                Ashiya.sendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: msg })
            }
            break
		    ...
		    image: { url: anu.result.thumb },
                ...
                let msg = await Ashiya.sendMessage(m.chat, buttonMessage, { quoted: m })
                Ashiya.sendMessage(m.chat, { audio: { url: anu.result.audio } }, { quoted: msg })
            }
            break
	        case 'fbdlx': case 'fbx': case 'facebookx': {
                ...
                Ashiya.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `📝 Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        Ashiya.sendMessage(m.chat, { image: { url }, caption: `📝 Title : ${anu.title}\n📝 Author : ${anu.author.name}\n📝 Like : ${anu.like}\n📝 Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		Ashiya.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
		case 'iqraxxx': {
		...
		Ashiya.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:m}).catch ((err) => reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
		reply(mess.wait)
		Ashiya.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		reply(mess.wait)
		Ashiya.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		reply(mess.wait)
		Ashiya.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		reply(mess.wait)
		Ashiya.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		reply(txt)
		Ashiya.sendMessage(m.chat, {audio: { url: res.result.data.audio.primary }, mimetype: 'audio/mpeg'}, { quoted : m })
		}
		break
		case 'tafsirsurahxxx': {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		...
		break
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'squirrel':
                ...
                Ashiya.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                Ashiya.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {
                if (!isCreator) return replay(`${mess.owner}`)
...
View List Of Messages With ${prefix}listmsg`)
            ...
            case 'getmsg': {
                ...
                Ashiya.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
	    ...
	    case 'anonymous': {
                ...
                Ashiya.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await Ashiya.getName(m.sender)} Welcome To Anonymous Chat\n\nClick The Button Below To Find A Partner\`\`\``, Ashiya.user.name, m)
            }
			break
            case 'keluar': case 'leave': {
                ...
                if (!room) {
                    ...
                    await Ashiya.sendButtonText(m.chat, buttons, `\`\`\`You Are Not In An Anonymous Session, Press The Button To Find A Partner \`\`\``)
                   reply(false)
                }
                reply('Ok')
                let other = room.other(m.sender)
                if (other) await Ashiya.sendText(other, `\`\`\`Partner Has Left Anonymous Session\`\`\``, m)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await Ashiya.sendButtonText(m.chat, buttons, `\`\`\`You Are Still In An Anonymous Session, Press The Button Below To Terminate Your Anonymous Session\`\`\``, Ashiya.user.name, m)
                    reply(false)
                }
                ...
                if (room) {
                    ...
                    await Ashiya.sendButtonText(room.a, buttons, `\`\`\`Successfully Found Partner, Now You Can Send Message\`\`\``, Ashiya.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await Ashiya.sendButtonText(room.b, buttons, `\`\`\`Successfully Found Partner, Now You Can Send Message\`\`\``, Ashiya.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await Ashiya.sendButtonText(m.chat, buttons, `\`\`\`Please Wait, Looking For A Partner\`\`\``, Ashiya.user.name, m)
                }
                break
            }
...
case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
					...
					.then(({data}) => {
						Ashiya.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
					})
					break
...
😇 𝗙𝗿𝗼𝗺 𝗤𝗨𝗘𝗘𝗡 𝗔𝗦𝗛𝗜𝗬𝗔\n\nDear owner,\nIf you use bot commands,\nYou should be delete it for everyone after send.\nElse, if your bot refreshing or restarting times, your bot send auto replies for your messages non stop. \nIt is a interruption to users.\n This note only for bot owner.\n \n \nᴘᴏᴡᴇʀᴇᴅ ʙʏ  ɪꜱʜᴀɴ ꜱᴀɴᴅᴇᴇᴘᴀ`)
                                replay(`හායි,  ${global.ownername}  👋\n
😇 𝗤𝗨𝗘𝗘𝗡 𝗔𝗦𝗛𝗜𝗬𝗔 විසින්\n\nඅයිිතිකරු වෙත,\nඔබ විසින් විධාන භාවිතා කරනවානම් එය සැමගෙන් මකා දැමිය යුතුය.\nඑසේ නොකළහොත් ඔබේ බොට් ක්‍රියාකාරීත්වය අලුත් වන සෑම විටම ඔබ යැවූ විධාන සඳහා කිහිප වරක් හෝ දිගටම Auto Reply යැවීමට ඉඩ ඇත. \nමෙය අයිතිකරු හට පමණක් වලංගු වේ.\n \n \nᴘᴏᴡᴇʀᴇᴅ ʙʏ  ɪꜱʜᴀɴ ꜱᴀɴᴅᴇᴇᴘᴀ`)
                            }
                            break
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ  ɪꜱʜᴀɴ ꜱᴀɴᴅᴇᴇᴘᴀ `,unicorn, [{"quickReplyButton": {"displayText": "🖥️ 𝗕𝗢𝗧 𝗜𝗡𝗙𝗢 🖥️","id": 'info'}},{"quickReplyButton": {"displayText": "𝙊𝙒𝙉𝙀𝙍 🙋‍","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
                    if (!isCreator) return reply(mess.owner)
		...
		if (isCmd && budy.toLowerCase() != undefined) {
		    ...
		    Ashiya.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
		}
        }
